...
namespace ProyectoIntroMVC.Controllers
{
    public class PersonajesController : Controller
    {
        private readonly DbEscritorioContext _context;

        public PersonajesController(DbEscritorioContext context)
        {
            _context = context;
        }
        ...
        {
            var dbEscritorioContext = _context.Personajes.Include(p => p.PerLib).Include(p => p.PerRol);
            return View(await dbEscritorioContext.ToListAsync());
        }
